...
export default function DiagnosticPreview() {
  ...
  return (
    <section id="diagnostic" className="py-32 bg-[#0A0A0B] border-b border-white/[0.04] relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-normal text-warmWhite leading-tight">
          ...
          <div className="lg:col-span-7 bg-[#141416] border border-white/[0.05] p-6 sm:p-12 shadow-2xl relative">
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 border text-[10px] uppercase tracking-wider font-mono focus:outline-none transition-colors duration-200 cursor-pointer ${
                      isActive
            ...
            <div className="mt-8 pt-8 border-t border-white/[0.05] flex justify-between items-center flex-wrap gap-4">
              ...
              <Link
                href="#apply"
                className="text-xs uppercase tracking-[0.2em] text-white border-b border-white pb-1 hover:text-mutedGray hover:border-mutedGray transition-colors duration-300"
              >
